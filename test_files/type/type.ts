...
let typeAny: any;
let typeArr: Array<any> = null as any;
let typeArr2: any[] = null as any;
let typeNestedArr: {a:any}[][] = null as any;
let typeObject: {a:number, b:string} = {a:3, b:'b'};
let typeObject2: {[key:string]: number} = null as any;
let typeObject3: {a:number, [key:string]: number} = null as any;
let typeObjectEmpty: {} = null as any;
