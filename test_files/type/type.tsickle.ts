...
let /** @type {Array<?>} */ typeArr: Array<any> = /** @type {?} */(( null as any));
let /** @type {Array<?>} */ typeArr2: any[] = /** @type {?} */(( null as any));
let /** @type {Array<Array<{a: ?}>>} */ typeNestedArr: {a:any}[][] = /** @type {?} */(( null as any));
let /** @type {{a: number, b: string}} */ typeObject: {a:number, b:string} = {a:3, b:'b'};
let /** @type {Object<string,number>} */ typeObject2: {[key:string]: number} = /** @type {?} */(( null as any));
let /** @type {?} */ typeObject3: {a:number, [key:string]: number} = /** @type {?} */(( null as any));
let /** @type {Object} */ typeObjectEmpty: {} = /** @type {?} */(( null as any));
